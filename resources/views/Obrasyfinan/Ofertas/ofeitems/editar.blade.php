...
@section('content')
    <section class="section">
        <div class="section-header">
            <h3 class="page__heading">Editar Item: {{$unItem->nom_item}}</h3>
        </div>
        ...
        <div style="width:99%;float:left;">
            <div style="width:15%;float:left;margin-left:1%;">
                ...
                {!! Form::text('costo', $unItem->costo, ['class' => 'form-control']) !!}
            </div>
            <div style="width:15%;float:left;margin-left:1%;">
                {!! Form::label('Porc. Inc.:', null, ['class' => 'control-label', 'style' => 'white-space: nowrap; ']) !!}
                {!! Form::text('por_inc', $unItem->por_inc, ['class' => 'form-control']) !!}
            </div>
            <div style="width:15%;float:left;margin-left:1%;">
