                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row ">
                                                            ...
                                                            @foreach ($roles as $value)
                                                                <tr id="trradio{{ $value->id }}">
                                                                    <td style="width: 90%"><label>
                                                                            {{ Form::radio('roless', $value->id, false, ['onclick' => 'buscarpermisos(' . $value->id . ');handleRadioClick(this)', 'id' => 'rr' . $value->id, 'class' => 'name ']) }}
                                                                            {{ $value->name }}</label></td>
                                                                    <td>{{ Form::checkbox('roles[]', $value->id, false, ['id' => 'r' . $value->id, 'disabled' => 'disabled', 'onclick' => '', 'class' => 'name']) }}
                                                                    </td>
                                                                </tr>
                                                            @endforeach
                                                        </tbody>
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12">
                                @can('CREAR-USUARIO')
                                {!! Form::button('Nuevo', ['onclick' => 'clickSubmit()', 'class' => 'btn btn-warning mr-2']) !!}
                                {!! Form::submit('Nuevo', ['id' => 'submit', 'class' => 'd-none']) !!}
                                {!! link_to_route(
                                    'usuarios.index',
                                    $title = 'Volver',
                                    $parameters = [],
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12">
                                <div class="card  border border-3 border-primary border-opacity-75 rounded">
                                    ...
                                    <div class="d-flex flex-row align-items-start justify-content-around ">
                                        <div class="card-body ms-2 d-flex flex-column" id="lista_roles"style="height: 245px;width:50%">
                                        ...
                                        <div class="card me-3  mt-3" style="background-color: rgb(255, 255, 255);height: 400px;width:70%">
                                            <div class="card-body ms-2 " id="lista_roles" >
                                                ...
                                                <div id="grupos4" class="d-flex flex-column "
                                                    style="">
                                                    <ul id="menu">
                                                        @include('Coordinacion.Informatica.GestionUsuarios.usuarios.menu-vistausuario')
                                                    </ul>
                                                </div>
                                            </div>
                                        </div>                                        
