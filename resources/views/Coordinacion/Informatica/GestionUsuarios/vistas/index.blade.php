...
@section('content')
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                    <div class="row justify-content-evenly align-items-evenly">
                                        <div class="col-xs-2 col-sm-1 col-md-2 col-lg-1">
                                            @can('crear-permiso')
                                                {!! Form::open(['method' => 'GET', 'route' => ['vistas.create'], 'class' => 'd-flex justify-content-evenly']) !!}
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        @can('editar-permiso')
                                                            {!! Form::open(['method' => 'GET', 'route' => ['vistas.edit', $vista->id], 'style' => 'display:inline']) !!}
    ...
    <script src="{{ asset('js/Coordinacion/Informatica/vistas/index_vistas.js') }}"></script>
@endsection
