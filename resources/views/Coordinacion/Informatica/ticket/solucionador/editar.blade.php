...
<section class="section">
    <div class="section-header">
        <h3 class="page__heading">Editar Solucionador</h3>
    </div>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    ...
                    {!! Form::model($Solucionador, ['method' => 'PATCH','route' => ['solucionador.update', $Solucionador->idsolucionador]]) !!}
                        <div class="row">
                                ...
                                <div class="form-group d-flex align-items-center">
                                    ...
                                    <select class="form-select" name="tipo" placeholder="Seleccionar">
                                        @foreach ($Tipos as $Tipo)
                                            @if($Solucionador->idtipsolucionador == $Tipo->idtipsolucionador)
                                                <option value={{"$Tipo->idtipsolucionador"}} selected>{{$Tipo->destipsolucionador}}</option>
                                            @else
