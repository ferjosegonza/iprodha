...
use App\Models\Iprodha\BarrioCostos;
...
class BarrioCostosController extends Controller
{
   ...
   /* public function create(Request $request)
    {
        return view('barrioCostos.crear');   
    }*/
  ...
  /*  public function store(Request $request)
    ...
    {
            //$Costos = BarrioCostos::find($barrio);
            $unBarrio = Barrio::find($barrio);
            $Costos = BarrioCostos::where('barrio', 'like', $unBarrio->barrio )->paginate(10);
            $Dormis1 = BarrioCostos::select('cantdorm')->distinct()->where('barrio', 'like', $unBarrio->barrio )->get();
            ...
            //$Dormis1 = collect($collection);
            //$Dormis1 = collect($Dormis);
    ...
    public function show1(){ 
        ...
        return redirect()->route('Barrio.index')->with('alerta','Ya existe la obra.!');
     } 
