...
class Ofe_itemController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('Obrasyfinanciamiento.Ofertasobra.ofeitems.index',compact('itemsxobra'));
    }
    public function create($idobra)
    {
        $laObra = Ofe_obra::find($idobra);
        return view('Obrasyfinanciamiento.Ofertasobra.ofeitems.crear',compact('laObra'));
    }    
    public function edit($itemId)
    {
        $unItem = Ofe_item::find($itemId);
        $laObra =$unItem->getObra;
        return view('Obrasyfinanciamiento.Ofertasobra.ofeitems.editar',compact('unItem','laObra'));
    }
    public function itemsxoferta ($idobra){
        $laObra = Ofe_obra::find($idobra);
        $itemsxobra =  $laObra->getItems ;
        return view('Obrasyfinanciamiento.Ofertasobra.ofeitems.index',compact('laObra','itemsxobra'));
    } 
