...
Route::group(['middleware' => ['auth','role_or_permission:ADMIN|VER-OFECRONO']], function () {
    ...
    Route::get('/ofecrono/{item}/limpiar', [Ofe_cronogramaController::class, 'limpiarAvanceITem'])->name('ofecrono.limpiar');
    Route::post('/ofecrono/{id}/{mes}/items', [Ofe_cronogramaController::class, 'losItems']);
    Route::post('/ofecrono/{mes}/{item}/buscar', [Ofe_cronogramaController::class, 'buscarItemMes']);
...
Route::group(['middleware' => ['auth','role_or_permission:ADMIN|EMPRESA|OFEOBRA']], function () {
    ...
    Route::get('/ofeobra/{idobra}/pdfitemsgral', [ofe_obraController::class, 'pdfItemsGralAlt'])->name('ofeobraItemsGral.pdf');
    Route::get('/ofeobra/{idobra}/pdfitemsubitem', [ofe_obraController::class, 'pdfItemsSubitems'])->name('ofeobraItemsSubitems.pdf');
